...
export type GetNetworkMessagingResponseDeprecated = MessagingResponse & GetNetworkResponseDeprecated;
...
export type GetAddressMessagingResponseDeprecated = MessagingResponse & GetAddressResponseDeprecated;
export type GetPublicKeyMessagingResponse = MessagingResponse & GetPublicKeyResponse;
export type GetPublicKeyMessagingResponseDeprecated = MessagingResponse & GetPublicKeyResponseDeprecated;
...
export type SignMessageMessagingResponseDeprecated = MessagingResponse & SignMessageResponseDeprecated;
...
export type SubmitBulkTransactionsMessagingResponse = MessagingResponse & SubmitBulkTransactionsResponse;
...
export type SendPaymentMessagingResponseDeprecated = MessagingResponse & SendPaymentResponseDeprecated;
...
export type SetTrustlineMessagingResponseDeprecated = MessagingResponse & SetTrustlineResponseDeprecated;
export type PasswordInternalMessagingResponse = InternalMessagingResponse & PasswordInternalResponse;
...
export type EventContentMessage = EventNetworkChangedContentMessage | EventWalletChangedContentMessage | EventLoginContentMessage | EventLogoutContentMessage;
type BackgroundMessagePayload = {
    payload: {
        id: number;
    };
};
export type ReceiveSendPaymentBackgroundMessage = ReceiveSendPaymentContentMessage & BackgroundMessagePayload;
export type ReceiveSendPaymentBackgroundMessageDeprecated = ReceiveSendPaymentContentMessageDeprecated & BackgroundMessagePayload;
export type ReceiveSetTrustlineBackgroundMessage = ReceiveSetTrustlineContentMessage & BackgroundMessagePayload;
export type ReceiveSetTrustlineBackgroundMessageDeprecated = ReceiveSetTrustlineContentMessageDeprecated & BackgroundMessagePayload;
export type ReceiveGetAddressBackgroundMessage = ReceiveGetAddressContentMessage & BackgroundMessagePayload;
export type ReceiveGetAddressBackgroundMessageDeprecated = ReceiveGetAddressContentMessageDeprecated & BackgroundMessagePayload;
export type ReceiveGetNetworkBackgroundMessage = ReceiveGetNetworkContentMessage & BackgroundMessagePayload;
export type ReceiveGetNetworkBackgroundMessageDeprecated = ReceiveGetNetworkContentMessageDeprecated & BackgroundMessagePayload;
export type ReceiveGetNFTBackgroundMessage = ReceiveGetNFTContentMessage & BackgroundMessagePayload;
export type ReceiveGetNFTBackgroundMessageDeprecated = ReceiveGetNFTContentMessageDeprecated & BackgroundMessagePayload;
export type ReceivePublicKeyBackgroundMessage = ReceiveGetPublicKeyContentMessage & BackgroundMessagePayload;
export type ReceivePublicKeyBackgroundMessageDeprecated = ReceiveGetPublicKeyContentMessageDeprecated & BackgroundMessagePayload;
export type ReceiveSignMessageBackgroundMessage = ReceiveSignMessageContentMessage & BackgroundMessagePayload;
export type ReceiveSignMessageBackgroundMessageDeprecated = ReceiveSignMessageContentMessageDeprecated & BackgroundMessagePayload;
export type ReceiveMintNFTBackgroundMessage = ReceiveMintNFTContentMessage & BackgroundMessagePayload;
export type ReceiveCreateNFTOfferBackgroundMessage = ReceiveCreateNFTOfferContentMessage & BackgroundMessagePayload;
export type ReceiveCancelNFTOfferBackgroundMessage = ReceiveCancelNFTOfferContentMessage & BackgroundMessagePayload;
export type ReceiveAcceptNFTOfferBackgroundMessage = ReceiveAcceptNFTOfferContentMessage & BackgroundMessagePayload;
export type ReceiveBurnNFTBackgroundMessage = ReceiveBurnNFTContentMessage & BackgroundMessagePayload;
export type ReceiveSetAccountBackgroundMessage = ReceiveSetAccountContentMessage & BackgroundMessagePayload;
export type ReceiveSetRegularKeyBackgroundMessage = ReceiveSetRegularKeyContentMessage & BackgroundMessagePayload;
export type ReceiveCreateOfferBackgroundMessage = ReceiveCreateOfferContentMessage & BackgroundMessagePayload;
export type ReceiveCancelOfferBackgroundMessage = ReceiveCancelOfferContentMessage & BackgroundMessagePayload;
export type ReceiveSignTransactionBackgroundMessage = ReceiveSignTransactionContentMessage & BackgroundMessagePayload;
export type ReceiveSubmitTransactionBackgroundMessage = ReceiveSubmitTransactionContentMessage & BackgroundMessagePayload;
export type ReceiveSubmitBulkTransactionsBackgroundMessage = ReceiveSubmitBulkTransactionsContentMessage & BackgroundMessagePayload;
export type ReceiveSetHookBackgroundMessage = ReceiveSetHookContentMessage & BackgroundMessagePayload;
export type InternalReceivePasswordBackgroundMessage = InternalReceivePasswordContentMessage & BackgroundMessagePayload;
export type InternalReceiveSignedOutBackgroundMessage = InternalReceiveSignOutContentMessage & BackgroundMessagePayload;
export type EventNetworkChangedBackgroundMessage = EventNetworkChangedContentMessage & BackgroundMessagePayload;
export type EventWalletChangedBackgroundMessage = EventWalletChangedContentMessage & BackgroundMessagePayload;
...
export type BackgroundMessage = RequestAcceptNFTOfferMessage | RequestBurnNFTMessage | RequestCancelNFTOfferMessage | RequestCancelOfferMessage | RequestCreateNFTOfferMessage | RequestCreateOfferMessage | RequestGetAddressMessage | RequestGetAddressMessageDeprecated | RequestGetNetworkMessage | RequestGetNetworkMessageDeprecated | RequestGetNFTMessage | RequestGetNFTMessageDeprecated | RequestGetPublicKeyMessage | RequestGetPublicKeyMessageDeprecated | RequestMintNFTMessage | RequestSendPaymentMessage | RequestSendPaymentMessageDeprecated | RequestSetAccountMessage | RequestSetHookMessage | RequestSetRegularKeyMessage | RequestSetTrustlineMessage | RequestSetTrustlineMessageDeprecated | RequestSignMessageMessage | RequestSignMessageMessageDeprecated | RequestSignTransactionMessage | RequestSubmitTransactionMessage | RequestSubmitBulkTransactionsMessage | EventLoginBackgroundMessage | EventLogoutBackgroundMessage | EventNetworkChangedBackgroundMessage | EventWalletChangedBackgroundMessage | ReceiveAcceptNFTOfferBackgroundMessage | ReceiveBurnNFTBackgroundMessage | ReceiveCancelNFTOfferBackgroundMessage | ReceiveCancelOfferBackgroundMessage | ReceiveCreateNFTOfferBackgroundMessage | ReceiveCreateOfferBackgroundMessage | ReceiveGetAddressBackgroundMessage | ReceiveGetAddressBackgroundMessageDeprecated | ReceiveGetNetworkBackgroundMessage | ReceiveGetNetworkBackgroundMessageDeprecated | ReceiveGetNFTBackgroundMessage | ReceiveGetNFTBackgroundMessageDeprecated | ReceiveMintNFTBackgroundMessage | ReceivePublicKeyBackgroundMessage | ReceivePublicKeyBackgroundMessageDeprecated | ReceiveSetAccountBackgroundMessage | ReceiveSetHookBackgroundMessage | ReceiveSetRegularKeyBackgroundMessage | ReceiveSendPaymentBackgroundMessage | ReceiveSendPaymentBackgroundMessageDeprecated | ReceiveSetTrustlineBackgroundMessage | ReceiveSetTrustlineBackgroundMessageDeprecated | ReceiveSignMessageBackgroundMessage | ReceiveSignMessageBackgroundMessageDeprecated | ReceiveSignTransactionBackgroundMessage | ReceiveSubmitTransactionBackgroundMessage | ReceiveSubmitBulkTransactionsBackgroundMessage | InternalRequestPasswordMessage | InternalReceivePasswordBackgroundMessage | InternalReceiveSignedOutBackgroundMessage;
export interface RequestIsInstalledMessage {
    app: typeof GEM_WALLET;
    type: 'REQUEST_IS_INSTALLED/V3';
}
export type APIMessages = RequestAcceptNFTOfferMessage | RequestBurnNFTMessage | RequestCancelNFTOfferMessage | RequestCancelOfferMessage | RequestCreateNFTOfferMessage | RequestCreateOfferMessage | RequestGetAddressMessage | RequestGetNetworkMessage | RequestGetNFTMessage | RequestGetPublicKeyMessage | RequestMintNFTMessage | RequestIsInstalledMessage | RequestSendPaymentMessage | RequestSetAccountMessage | RequestSetHookMessage | RequestSetRegularKeyMessage | RequestSetTrustlineMessage | RequestSignMessageMessage | RequestSignTransactionMessage | RequestSubmitTransactionMessage | RequestSubmitBulkTransactionsMessage;
export {};
