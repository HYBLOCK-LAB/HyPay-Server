...
import { AcceptNFTOfferRequest, BurnNFTRequest, CancelNFTOfferRequest, CancelOfferRequest, CreateNFTOfferRequest, CreateOfferRequest, EventLoginResponse, EventLogoutResponse, EventNetworkChangedResponse, EventWalletChangedResponse, MintNFTRequest, SendPaymentRequest, SendPaymentRequestDeprecated, SetAccountRequest, SetHookRequest, SetRegularKeyRequest, SetTrustlineRequest, SetTrustlineRequestDeprecated, SignMessageRequest, SignTransactionRequest, SubmitTransactionRequest, SubmitBulkTransactionsWithKeysRequest, WebsiteRequest } from '../payload/payload.types';
interface MessageEventData {
    app: typeof GEM_WALLET;
    type: RequestMessage;
    source: 'GEM_WALLET_MSG_REQUEST';
    messageId: number;
    payload?: AcceptNFTOfferRequest | BurnNFTRequest | CancelNFTOfferRequest | CancelOfferRequest | CreateNFTOfferRequest | CreateOfferRequest | MintNFTRequest | SendPaymentRequest | SendPaymentRequestDeprecated | SetAccountRequest | SetHookRequest | SetRegularKeyRequest | SetTrustlineRequest | SetTrustlineRequestDeprecated | SignMessageRequest | SubmitTransactionRequest | SubmitBulkTransactionsWithKeysRequest | WebsiteRequest;
}
...
export type EventListener = AcceptNFTOfferEventListener | AddressEventListener | AddressEventListenerDeprecated | BurnNFTEventListener | CancelNFTOfferEventListener | CancelOfferEventListener | CreateNFTOfferEventListener | CreateOfferEventListener | GetNFTEventListener | GetNFTEventListenerDeprecated | MintNFTEventListener | NetworkEventListener | NetworkEventListenerDeprecated | PublicKeyEventListener | PublicKeyEventListenerDeprecated | PaymentEventListener | PaymentEventListenerDeprecated | SetAccountEventListener | SetHookEventListener | SetRegularKeyEventListener | SetTrustlineEventListener | SetTrustlineEventListenerDeprecated | SignMessageListener | SignMessageListenerDeprecated | SignTransactionEventListener | SubmitTransactionEventListener | SubmitBulkTransactionsEventListener;
export interface EventEventData {
    app: typeof GEM_WALLET;
    type: EventMessage;
    source: 'GEM_WALLET_MSG_REQUEST';
    messageId: number;
    payload?: EventNetworkChangedResponse | EventWalletChangedResponse | EventLoginResponse | EventLogoutResponse;
}
...
export type EventEventListener = EventNetworkChangedEventListener | EventWalletChangedEventListener | EventLoginEventListener | EventLogoutEventListener;
export {};
